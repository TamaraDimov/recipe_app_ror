...
RSpec.describe 'recipes/public.html.erb', type: :view do
  it 'displays a list of public recipes' do
    ...
    recipe1 = double('Recipe', id: 1, name: 'Recipe 1', user: double('User', name: 'User 1'),
                               foods: double('Foods', count: 3, sum: 15))
    recipe2 = double('Recipe', id: 2, name: 'Recipe 2', user: double('User', name: 'User 2'),
                               foods: double('Foods', count: 5, sum: 25))
